                ...
                <div class="col-2">
                    ...
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/women1-details1.png" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/women1-details2.png" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/women1-details3.png" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/women1-details4.png" width="100%" class="small-img">
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <form method="post" action="product-details2.php?action=add&id=<?php echo $row["id"]; ?>">
                    <p>Prducts / T-Shirt</p>
                    ...
                    <p>Stylish washed jersey, created for the best comfort for exercising in cool weather. This product is made from at least 65% recycled polyester fibres.</p>
                </div>
            </div>
        </div>

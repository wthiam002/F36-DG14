                ...
                <div class="col-2">
                    ...
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/men2-details1.png" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/men2-details2.png" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/men2-details3.png" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/men2-details4.png" width="100%" class="small-img">
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <form method="post" action="product-details3.php?action=add&id=<?php echo $row["id"]; ?>">
                    <p>Prducts / T-Shirt</p>
                    ...
                    <p>Grey fleece fabric in a laid-back style defines the Nike Hoodie. A truly classic piece with a loose and easy fit, feel warm and comfortable all day wear.</p>
                </div>
            </div>
        </div>
